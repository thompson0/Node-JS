...
router.get('/pessoas/:estudanteid/matricula', (req, res) => pessoaController.pegaMatriculas(req, res));
router.post('/pessoas/:estudanteid/matricula', (req, res) => matriculaController.criaNovo(req, res));
